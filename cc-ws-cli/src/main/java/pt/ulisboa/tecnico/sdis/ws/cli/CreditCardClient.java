...
public class CreditCardClient implements CreditCard {
	...
	/** constructor with default web service URL */
  public CreditCardClient() throws CreditCardClientException {
    this("http://ws.sd.rnl.tecnico.ulisboa.pt:8080/cc");
  }
  ...
  @Override
  public boolean validateNumber(String creditCardNumber) {
    return port.validateNumber(creditCardNumber);
  }
}
